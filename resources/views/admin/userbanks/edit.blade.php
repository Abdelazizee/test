...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.userbank.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.userbanks.update", [$userbank->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label for="bank_holder_name">{{ trans('cruds.userbank.fields.bank_holder_name') }}</label>
                <input class="form-control {{ $errors->has('bank_holder_name') ? 'is-invalid' : '' }}" type="text" name="bank_holder_name" id="bank_holder_name" value="{{ old('bank_holder_name', $userbank->bank_holder_name) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('iban') ? 'is-invalid' : '' }}" type="text" name="iban" id="iban" value="{{ old('iban', $userbank->iban) }}">
                @if($errors->has('iban'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('bank_name') ? 'is-invalid' : '' }}" type="text" name="bank_name" id="bank_name" value="{{ old('bank_name', $userbank->bank_name) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('bank_number') ? 'is-invalid' : '' }}" type="text" name="bank_number" id="bank_number" value="{{ old('bank_number', $userbank->bank_number) }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('active') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="active" id="active" value="1" {{ $userbank->active || old('active', 0) === 1 ? 'checked' : '' }}>
