            ...
            <table class=" table table-bordered table-striped table-hover datatable datatable-Bank">
                <thead>
                    <tr>
                        ...
                        <th>
                            {{ trans('cruds.bank.fields.holder_name') }}
                        </th>
                        <th>
                            {{ trans('cruds.bank.fields.active') }}
                        </th>
                        <th>
                            &nbsp;
                        </th>
                ...
                <tbody>
                    @foreach($banks as $key => $bank)
                        <tr data-entry-id="{{ $bank->id }}">
                            ...
                            <td>
                                <span style="display:none">{{ $bank->active ?? '' }}</span>
                                <input type="checkbox" disabled="disabled" {{ $bank->active ? 'checked' : '' }}>
                            </td>
                            <td>
                                @can('bank_show')
