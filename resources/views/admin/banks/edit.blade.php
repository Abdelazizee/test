    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.banks.update", [$bank->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('iban') ? 'is-invalid' : '' }}" type="text" name="iban" id="iban" value="{{ old('iban', $bank->iban) }}">
                @if($errors->has('iban'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('holder_name') ? 'is-invalid' : '' }}" type="text" name="holder_name" id="holder_name" value="{{ old('holder_name', $bank->holder_name) }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('active') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="active" id="active" value="1" {{ $bank->active || old('active', 0) === 1 ? 'checked' : '' }}>
